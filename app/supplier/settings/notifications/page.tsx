...
export default function SupplierNotificationsSettingsPage() {
  return (
    <div className="max-w-3xl">
      ...
      <NotificationsSection perspective="supplier" />
    </div>
  );
}
...
function SettingsTabs({ current }: { current: "integrations" | "notifications" }) {
  const tabs = [
    { id: "integrations", label: "外部サービス連携", href: "/supplier/settings/integrations" },
    { id: "notifications", label: "通知設定", href: "/supplier/settings/notifications" },
  ];
  return (
